...
const  ROOT_POSITION  = [-0.0, -0.0, -30.0];
...
//
  ...
  mainNode.buffers = initBuffers(createSphereVertices(1, 10, 10));
...
function drawScene( programInfo, deltaTime ) 
{
  ...
  */
  ...
  nodesList[0].updateWorldMatrix();
  
  //mat4.rotate(mainNode.localMatrix, mainNode.localMatrix, -0.05, [1.0, 0.0, 0.0]);
