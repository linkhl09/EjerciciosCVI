      ...
      (p.SVGtoBeziers = function(t) {
        ...
        (p.cubicFromPoints = function(t, n, i, e, o) {
          ...
          var u = o * (1 - e) / e,
            ...
            b = { x: z.x + (m.x - z.x) / e, y: z.y + (m.y - z.y) / e },
            _ = { x: t.x + (g.x - t.x) / e, y: t.y + (g.y - t.y) / e },
            w = {
              x: i.x + (b.x - i.x) / (1 - e),
              y: i.y + (b.y - i.y) / (1 - e)
            };
        ...
        (p.prototype = {
          ...
          on: function(t, r) {
            ...
            for (
              ...
              (n = i[s]), y.dist(n, t) < r && (e.push(n), (o += s / i.length));
          ...
          compute: function(t) {
            return this.ratios
              ? y.computeWithRatios(t, this.points, this.ratios, this._3d)
              : y.compute(t, this.points, this._3d, this.ratios);
          },
          raise: function() {
            for (
              var t, r, n, i = this.points, e = [i[0]], o = i.length, t = 1;
              o > t;
              t++
            )
              (r = i[t]),
          ...
          derivative: function(t) {
            var r,
              ...
              e = 0,
              o = this.dpoints[0];
            2 === this.order && ((o = [o[0], o[1], x]), (r = i), (n = t)),
              3 === this.order && ((r = i * i), (n = i * t * 2), (e = t * t));
            var s = {
              x: r * o[0].x + n * o[1].x + e * o[2].x,
              y: r * o[0].y + n * o[1].y + e * o[2].y
            };
            return this._3d && (s.z = r * o[0].z + n * o[1].z + e * o[2].z), s;
          },
          ...
          hull: function(t) {
            ...
            for (
              ...
              for (i = [], s = 0, u = n.length - 1; u > s; s++)
                (r = y.lerp(t, n[s], n[s + 1])), (e[o++] = r), i.push(r);
              n = i;
            }
            return e;
          },
          ...
          offset: function(t, r) {
            if ("undefined" != typeof r) {
              var n = this.get(t),
                i = this.normal(t),
                e = { c: n, n: i, x: n.x + i.x * r, y: n.y + i.y * r };
              return this._3d && (e.z = n.z + i.z * r), e;
            }
            if (this._linear) {
              var o = this.normal(0),
                s = this.points.map(function(r) {
                  var n = { x: r.x + t * o.x, y: r.y + t * o.y };
                  return r.z && i.z && (n.z = r.z + t * o.z), n;
                });
              return [new p(s)];
            }
            var u = this.reduce();
          ...
          simple: function() {
            if (3 === this.order) {
              var t = y.angle(this.points[0], this.points[3], this.points[1]),
                r = y.angle(this.points[0], this.points[3], this.points[2]);
              if ((t > 0 && 0 > r) || (0 > t && r > 0)) return !1;
            }
            var n = this.normal(0),
              i = this.normal(1),
              o = n.x * i.x + n.y * i.y;
                ...
                for (n = 0, i = 0; 1 >= i; )
                  for (i = n + o; 1 + o >= i; i += o)
                    if (((r = t.split(n, i)), !r.simple())) {
                      if (((i -= o), e(n - i) < o)) return [];
                      (r = t.split(n, i)),
                        (r._t1 = y.map(n, 0, 1, t._t1, t._t2)),
                        (r._t2 = y.map(i, 0, 1, t._t1, t._t2)),
                        u.push(r),
                        (n = i);
                      break;
                    }
                ...
                : ([0, 1].forEach(
                    function(t) {
                      if (2 !== this.order || !t) {
                        var n = f[t * r],
                          i = this.derivative(t),
                          e = { x: n.x + i.x, y: n.y + i.y };
                        f[t + 1] = y.lli4(n, e, u, a[t + 1]);
                      }
                    }.bind(this)
                  ),
                  new p(f))
          ...
          outline: function(t, r, n, i) {
            ...
            var o,
              ...
              c = 0,
              h = this.length(),
              x = "undefined" != typeof n && "undefined" != typeof i;
          ...
          outlineshapes: function(t, r, n) {
            r = r || t;
            for (
              var i = this.outline(t, r).curves, e = [], o = 1, s = i.length;
              s / 2 > o;
              o++
            ) {
          ...
          _iterate: function(t, r) {
            ...
            do {
              ...
              do {
                ...
                if (((l = t >= z), (h = p && !l), h || (d = e), l)) {
                  if (e >= 1) {
                    if (((f.interval.end = d = 1), (c = f), e > 1)) {
                      var g = { x: f.x + f.r * u(f.e), y: f.y + f.r * a(f.e) };
                      f.e += y.angle({ x: f.x, y: f.y }, g, this.get(1));
                    }
                    break;
                  }
                  e += (e - i) / 2;
      ...
      var r = Math.abs,
        ...
        d = {
          ...
          arcfn: function(t, r) {
            var n = r(t),
              i = n.x * n.x + n.y * n.y;
            return "undefined" != typeof n.z && (i += n.z * n.z), u(i);
          },
            ...
            if (4 > i) {
              ...
              2 === i
                ? ((e = [e[0], e[1], e[2], v]),
                  ...
                  (a = c))
                : 3 === i &&
                  ((s = f * o), (u = f * t * 3), (a = o * c * 3), (h = t * c));
              var x = {
                x: s * e[0].x + u * e[1].x + a * e[2].x + h * e[3].x,
                y: s * e[0].y + u * e[1].y + a * e[2].y + h * e[3].y
              };
              return (
                n && (x.z = s * e[0].z + u * e[1].z + a * e[2].z + h * e[3].z),
                x
              );
            }
            for (var y = JSON.parse(JSON.stringify(r)); y.length > 1; ) {
              ...
              2 === u.length
                ...
                : ((a *= o),
                  ...
                  3 === u.length
                    ? ((e = a + f + c),
                      {
                        x: (a * u[0].x + f * u[1].x + c * u[2].x) / e,
                        y: (a * u[0].y + f * u[1].y + c * u[2].y) / e,
                        z: i ? (a * u[0].z + f * u[1].z + c * u[2].z) / e : !1
                      })
                    : ((a *= o),
                      (f *= 1.5 * o),
                      (c *= 3 * o),
          ...
          derive: function(t, r) {
            for (var n = [], i = t, e = i.length, o = e - 1; e > 1; e--, o--) {
          ...
          lerp: function(t, r, n) {
            var i = { x: r.x + t * (n.x - r.x), y: r.y + t * (n.y - r.y) };
          ...
          findbbox: function(t) {
            ...
            return (
              ...
              {
                x: { min: r, mid: (r + i) / 2, max: i, size: i - r },
                y: { min: n, mid: (n + e) / 2, max: e, size: e - n }
              }
            );
          },
          ...
          roots: function(t, r) {
            ...
            var R = u(C);
            return (M = f(-T + R)), (v = f(T + R)), [M - v - a / 3].filter(s);
          },
          droots: function(t) {
            if (3 === t.length) {
              var r = t[0],
          ...
          pairiteration: function(t, r, n) {
            ...
            return 0 === f.length
              ...
              : (f.forEach(function(t) {
                  c = c.concat(d.pairiteration(t.left, t.right, s));
                }),
